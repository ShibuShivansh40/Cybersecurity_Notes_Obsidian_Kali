...
[ ] - API Keys
	...
	[ ] - OpenAI API Exploitation with Key - 
		[ ] - Use this command to check for the authenticity : `curl -i -s -H "Authorization: Bearer sk-proj-*" -H "Accept: application/json"  "https://api.openai.com/v1/chat/completions" -X GET`
